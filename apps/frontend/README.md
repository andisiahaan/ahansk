...
- **Port Pengembangan**: `10002` (berjalan secara serentak via `turbo run dev` dari root).
...
```
Atau jalankan seluruh monorepo dengan `pnpm run dev` dari root, lalu buka [http://localhost:10002](http://localhost:10002).
